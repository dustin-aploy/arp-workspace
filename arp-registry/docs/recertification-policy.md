...
ARP listings should age visibly. A registry entry that was credible at publication time may become stale when the protocol changes, the project changes, or the underlying evidence expires.
...
- the referenced ARP protocol version changes materially; or
...
- the ARP protocol receives a compatibility-impacting release;
...
The ARP ecosystem is about operational responsibility, not one-time badges. Short recertification windows preserve credibility by making listings version-aware, evidence-aware, and sensitive to real project drift.
