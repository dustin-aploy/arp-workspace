...
Across most frameworks, ARP logic should be attached at the following moments.
...
When confidence falls, policy conflicts appear, or an action needs approval, the adapter should trigger an ARP escalation path rather than silently continuing.
