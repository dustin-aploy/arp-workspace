...
Crew-style systems often model agents, tasks, and delegations. ARP should sit around task dispatch, delegation approval, and side-effecting task completion rather than trying to replace the crew orchestration model.
