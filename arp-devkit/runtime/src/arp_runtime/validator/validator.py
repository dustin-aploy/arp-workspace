...
from arp_runtime.loader.schema_loader import load_protocol_version, load_schema
from arp_runtime.types import ValidationResult
...
class ProtocolValidator:
    def __init__(self) -> None:
        self.schemas = {
            "arp.schema.json": load_schema("arp.schema.json"),
    ...
    def validate_agent_config(self, config: dict[str, Any]) -> ValidationResult:
        errors = self._validate_with_schema(config, self.schemas["arp.schema.json"], "$", self.schemas["arp.schema.json"])
