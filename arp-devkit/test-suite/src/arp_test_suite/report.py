...
from arp_runtime.loader.schema_loader import load_schema
from arp_runtime.validator.validator import ProtocolValidator
from arp_test_suite.compatibility import determine_compatibility
from arp_test_suite.result_types import CheckResult, ComplianceSummary
...
def build_report(
    *,
    ...
    report_id = _build_report_id(project, arp_spec_version, checks)
    summary = ComplianceSummary(
        kind="ARPComplianceReport",
        report_id=report_id,
        ...
        protocol_version=arp_spec_version,
        profile={
            "name": project,
            "version": SUITE_VERSION,
            "issuer": "arp-test-suite",
        },
        summary={
            "status": status,
            "passed": tests_passed,
...
def _build_report_id(project: str, arp_spec_version: str, checks: list[CheckResult]) -> str:
    digest_source = json.dumps(
        {
            "project": project,
            "arp_spec_version": arp_spec_version,
